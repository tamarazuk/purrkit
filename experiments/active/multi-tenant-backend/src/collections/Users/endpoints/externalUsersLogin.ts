...
import { APIError, generateCookie, generatePayloadCookie, getCookieExpiration } from 'payload'
      ...
      try {
        ...
        if (loginAttempt?.token) {
          ...
          const tenantCookie = generateCookie({
            ...
            value: String(fullTenant.id),
          })
          const responseHeaders = new Headers()
          responseHeaders.append('Set-Cookie', cookie)
          responseHeaders.append('Set-Cookie', tenantCookie as string)
